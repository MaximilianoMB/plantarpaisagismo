...
export default function Portfolio(){
    return(
        <div id="portfolio" className="mt-6 w-full bg-gradient-to-r from-stone-400 to-stone-300 rounded-tl-full rounded-br-full">
            <div className="max-w-[1240px] mx-auto px-2 py-10">
                <p className="text-xl tracking-widest uppercase text-[#65a30d]">
                   Projetos
                </p>
                <h2 className="py-4">Paisagismo Realizado</h2>
